...
psi = get_h8_minimum(HF_typ,pmg_typ,nlayer=2,manual_derivative=True,remove_redundant=True,U0=U0,symmetry=symmetry,rho_swap=rho_swap,propose_by=propose_by)
